...
| Estimated comp | 10% | 5 = top quartile (TC), 1 = below market |
| Growth trajectory | 10% | 5 = clear path to next level, 1 = dead end |
| Remote quality | 5% | 5 = full remote / async-friendly, 1 = onsite only |
| Company reputation | 5% | 5 = strong employer brand, 1 = red flags |
...
For each offer: score each dimension, then weighted total score.
